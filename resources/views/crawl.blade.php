...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <textarea class="form-control" rows="5" name="link">https://apii.online/kkphim/danh-sach/phim-moi-cap-nhat</textarea>
    ...
    <script>
        ...
        $("#movies-get-handle").click(async function() {
            const apiDomain = "{{ config('ophim_crawler.domain', 'https://apii.online/kkphim') }}";
